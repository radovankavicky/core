...
\title{Core Econometrics Textbook: Inference in Finite Samples}
\input{tex/preamble}
...
\include{inference/hypothesis_testing}
\include{inference/likelihood_ratio_test}
\include{inference/linear_regression}
\include{inference/bayesian_stats}
\include{inference/problems}
