...
\title[Point estimation in finite samples]%
{Point Estimation in Finite Samples \\
  Core Econometrics Textbook, part 2}
...
\include{estimation/introduction}
\include{estimation/derivation}
\include{estimation/optimality}
\include{estimation/intervals}
