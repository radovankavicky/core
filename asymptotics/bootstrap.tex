...
\item There are two approaches one could take, just based on what
  ...
  \lstinputlisting[lastline=3]{asymptotics/bootstrap_setup.R}

  and a simple function to plot the histogram along with the
  best-fitting Gaussian curve

  \lstinputlisting[firstline=5]{asymptotics/bootstrap_setup.R}
...
\item Of course, another approach would be to use the \emph{best}
  ...
  \lstinputlisting[firstline=3,lastline=5]{asymptotics/bootstrap_sample.R}
...
\item One potential use of the bootstrap is to estimate the variance
  ...
  \lstinputlisting[firstline=18,lastline=18]{asymptotics/bootstrap_sample.R}
  which equals \medv.
...
\item When the variance is easy to calculate, this isn't a big
  ...
  \lstinputlisting[firstline=20,lastline=20]{asymptotics/bootstrap_sample.R}
...
\item A complication shows up when you want to use the bootstrap for
  ...
  \lstinputlisting[firstline=26,lastline=26]{asymptotics/bootstrap_sample.R}
