...
\item There are two approaches one could take, just based on what
  ...
  \VerbatimInput{asymptotics/bootstrap.jl}
...
## block 2
  ...
  \begin{figure}\centering
    \begin{tabular}{cc}
      ...
      $\uniform(0,1)$
      r.v.s.]{\tryincludegraphics{asymptotics/bootstrap_u2.pdf}} &
      \subfloat[Sampling distribution of the mean of five exponential
      r.v.s.]{\tryincludegraphics{asymptotics/bootstrap_ex2.pdf}} \\

      \subfloat[Sampling distribution of the mean of 50 $\uniform(0,1)$
      r.v.s.]{\tryincludegraphics{asymptotics/bootstrap_u3.pdf}} &
      \subfloat[Sampling distribution of the mean of 50 exponential
      r.v.s.]{\tryincludegraphics{asymptotics/bootstrap_ex3.pdf}}
    \end{tabular}
